      ...
      {!done && (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, x: 40 }}
          ...
          <div className="p-3 rounded-xl mb-4" style={{ background: "#0F172A", border: "1px solid #1E293B" }}>
            <p className="text-xs font-semibold mb-1" style={{ color: "#6366F1" }}>🤖 Why AI suggests this:</p>
    ...
    <div className="p-8" style={{ color: "#F8FAFC" }}>
      <div className="max-w-4xl mx-auto">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <p style={{ color: "#94A3B8" }}>Personalised recommendations generated by Claude AI based on each student&apos;s performance data.</p>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}
          ...
          <h2 className="font-bold text-white mb-3">💬 Ask AI for Specific Help</h2>
          <div className="flex gap-3">
          ...
          <p className="text-xs mt-2" style={{ color: "#475569" }}>Powered by Claude AI · Analyses all student data to give targeted suggestions</p>
        </motion.div>
